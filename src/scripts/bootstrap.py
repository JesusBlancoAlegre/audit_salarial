...
def init_admin():
    with app.app_context():
        ...
        if admin_existente:
            print("El administrador admin@admin.com ya existe.")
            return
        ...
        print("GUARDA ESTA CONTRASEÑA AHORA. Solo se mostrará una vez.")
        print("Deberás cambiarla obligatoriamente en tu primer inicio de sesión.")
        print("=" * 50)
